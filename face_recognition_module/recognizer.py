...
# This set will store names of employees whose attendance is already marked today
...
while True:
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        if name != "Unknown":
            # Check if this employee's attendance is NOT already marked today
            if name not in already_marked_today:
                try:
                    ...
                    if employee:
                        ...
                        # Add name to the set to avoid re-marking
